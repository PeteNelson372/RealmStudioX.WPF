...
{
    /// <summary>
    /// Interaction logic for ResizeMapDialog.xaml
    /// </summary>
    public partial class ResizeMapDialog : ModalDialog, INotifyPropertyChanged
    {
        ...
        public ResizeMapDialog(RealmStudioMap map)
        {
            ...
            ViewModel = new ResizeMapViewModel(map);
        ...
        private void SetResizeAnchor(object sender, RoutedEventArgs e)
        {
            string anchorPoint = ((System.Windows.Controls.Button)sender).Tag.ToString() ?? "CenterZoomed";

            ViewModel.ResizeAnchorPoint = anchorPoint switch
            {
                "TopLeft" => ResizeMapAnchorPoint.TopLeft,
                "TopCenter" => ResizeMapAnchorPoint.TopCenter,
                "TopRight" => ResizeMapAnchorPoint.TopRight,
                "CenterLeft" => ResizeMapAnchorPoint.CenterLeft,
                "Center" => ResizeMapAnchorPoint.Center,
                "CenterRight" => ResizeMapAnchorPoint.CenterRight,
                "BottomLeft" => ResizeMapAnchorPoint.BottomLeft,
                "BottomCenter" => ResizeMapAnchorPoint.BottomCenter,
                "BottomRight" => ResizeMapAnchorPoint.BottomRight,
                _ => ResizeMapAnchorPoint.CenterZoomed
            };

            if (ViewModel.ScaleMapEnabled && ViewModel.ResizeAnchorPoint == ResizeMapAnchorPoint.Center)
            {
                ViewModel.ResizeAnchorPoint = ResizeMapAnchorPoint.CenterZoomed;
            }
        }
